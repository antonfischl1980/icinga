...
IUSE="${IUSE} php_targets_php7-4 php_targets_php8-0 php_targets_php8-1"
PHP_DEPEND="
	php_targets_php7-4? ( dev-lang/php:7.4[apache2?,cli,fpm?,gd,json,intl,ldap?,mysql?,nls,pdo,postgres?,sockets,ssl,xslt,xml] )
	php_targets_php8-0? ( dev-lang/php:8.0[apache2?,cli,fpm?,gd,intl,ldap?,mysql?,nls,pdo,postgres?,sockets,ssl,xslt,xml] )
	php_targets_php8-1? ( dev-lang/php:8.1[apache2?,cli,fpm?,gd,intl,ldap?,mysql?,nls,pdo,postgres?,sockets,ssl,xslt,xml] )
"
