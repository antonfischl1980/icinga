...
MY_PN="graphite-web"
COMMIT="ce4e991fa0220d50a1be2fd731a2b678f1e7bdeb"
DESCRIPTION="Enterprise scalable realtime graphing"
HOMEPAGE="https://graphiteapp.org/"
SRC_URI="https://github.com/graphite-project/graphite-web/archive/${COMMIT}.tar.gz -> ${P}.gh.tar.gz"
...
RDEPEND="
	...
	<dev-python/django-6[sqlite?,${PYTHON_USEDEP}]
...
PATCHES=(
	...
	"${FILESDIR}"/"${PN}"-1.1.10-fhs-paths.patch
)
